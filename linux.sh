    ...
    case $choice in
       ...
       4)
        ...
        6)
            ...
            ;;
           7 )
            曲线高速公路/高速公路/高速公路/高速公路/高速公路/高速公路/高速公路。 -sSf |Bash&弄反追踪
            ;;
           8 )
            打结< - 生命线 检查地点)
            ;;
           9 )
            ...
            ;;
           10 )
            猛击< -QO   - bash.spiritlhl.net/ecs)
            ;;
           11 )
            打结<-SSL https://linuxmirrors.cn/main.sh)
            ;;
            12 )
            打结< -SSL https://linuxmirrors.cn/main.sh) --edu
            ;;
           13 )
             如果 [ -F ];然后卷 -sSO HTPS://下载。 -O 安装版;安装版;安装版;安装版;安装版;安装版。
            ;;
          14 )
             当  真实的
            做
                清楚的
                回声 "提醒：国内服务器请先换源！否则无法安装docker！"
                回声 "1. 国内服务器安装1panel"
                回声 "2. 海外服务器安装1panel"
                回声 "q. 返回上一页"
                阅读     -P      "请输入选项: " 其他选择
                案例的 一美元  在…中
                   ...
                   1 )
                   打结< -SSL https://linuxmirrors.cn/docker.sh)
                   卷绕 -SSL https://resource.fit2cloud.com/1panel/package/quick_start.sh -O 快速启动。快速启动。
                   ;;
